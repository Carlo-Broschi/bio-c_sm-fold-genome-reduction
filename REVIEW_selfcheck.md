...
- [x] **Independent re-run reproduced (2026-07-05)**: fresh-seed IQ-TREE gives UFBoot≥95 45.4% (vs 43.0%) and logL −81,898.9 (vs −81,864.0, 0.04% diff) — confirms the poorly-resolved deep backbone; the paper cites the original committed run's values.
