...
**Novelty and prior work.** That DPANN and Asgard archaea encode Sm-like proteins was already indicated qualitatively (Reichelt et al. 2018), and we do not claim first detection. The genuinely new elements are the systematic, completeness-controlled and structurally-verified quantification of that retention; the two-mode bacterial Hfq-loss census; the rigorous CPR absence, the first assessment of these proteins in any CPR lineage; and the domain-level asymmetry that unifies them within a single structure-guided three-domain framework.
